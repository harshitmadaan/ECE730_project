...
Placements {
	...
	AnalyticalProfile "APP_Source_ext" {
		...
		ReferenceElement {
			Element = Line [(0.155 0.0415) (0.155 0.0535)]
			Direction = negative
		}
		EvaluateWindow {
			Element = Rectangle [(0.155 0.0415) (0.205 0.0535)]
		}
	}
	AnalyticalProfile "APP_Drain_ext" {
		Reference = "G_SDext_Dope"
		ReferenceElement {
			Element = Line [(0.205 0.0415) (0.205 0.0535)]
		}
		EvaluateWindow {
			Element = Rectangle [(0.155 0.0415) (0.205 0.0535)]
		}
	}
	Constant "C_PL_Source_Spacer_Source_Spacer_lump_1" {
		Reference = "C_Source_Spacer_Dope"
		EvaluateWindow {
			Element = region ["Source_Spacer_lump_1"]
		}
	}
	Constant "C_PL_Source_Spacer_Source_Spacer_lump_2" {
		Reference = "C_Source_Spacer_Dope"
		EvaluateWindow {
			Element = region ["Source_Spacer_lump_2"]
		}
	}
	Constant "C_PL_Drain_Spacer_Drain_Spacer_lump_1" {
		Reference = "C_Drain_Spacer_Dope"
		EvaluateWindow {
			Element = region ["Drain_Spacer_lump_1"]
		}
	}
	Constant "C_PL_Drain_Spacer_Drain_Spacer_lump_2" {
		Reference = "C_Drain_Spacer_Dope"
		EvaluateWindow {
			Element = region ["Drain_Spacer_lump_2"]
		}
	}
	Refinement "M_PL_Source" {
		Reference = "M_Source"
		RefineWindow = Rectangle [(0 0) (0.15 0.095)]
	}
	Refinement "M_PL_Drain" {
		Reference = "M_Drain"
		RefineWindow = Rectangle [(0.21 0) (0.36 0.095)]
	}
	Refinement "M_PL_Channel" {
		Reference = "M_Channel"
		RefineWindow = Rectangle [(0.15 0.0415) (0.21 0.0535)]
	}
	Refinement "M_PL_Bot_Ox" {
		Reference = "M_Ox"
		RefineWindow = Rectangle [(0.155 0.04) (0.205 0.0415)]
	}
	Refinement "M_PL_Top_Ox" {
		Reference = "M_Ox"
		RefineWindow = Rectangle [(0.155 0.0535) (0.205 0.055)]
	}
	Refinement "M_PL_Source_Spacer" {
		Reference = "M_Source_Spacer"
		RefineWindow = Rectangle [(0.15 0) (0.155 0.095)]
	}
