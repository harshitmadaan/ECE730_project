...
Placements {
	...
	Constant "C_PL_Drain_Spacer" {
		...
		EvaluateWindow {
			Element = Rectangle [(0.228 0.0415) (0.238 0.0575)]
		}
	}
	AnalyticalProfile "APP_Source_ext" {
		...
		EvaluateWindow {
			Element = Rectangle [(0.16 0.0415) (0.228 0.0575)]
		}
	}
	AnalyticalProfile "APP_Drain_ext" {
		Reference = "G_SDext_Dope"
		ReferenceElement {
			Element = Line [(0.228 0.0415) (0.228 0.0575)]
		}
		EvaluateWindow {
			Element = Rectangle [(0.16 0.0415) (0.228 0.0575)]
		}
	...
	Refinement "M_PL_Drain" {
		Reference = "M_Drain"
		RefineWindow = Rectangle [(0.238 0) (0.388 0.099)]
	}
	Refinement "M_PL_Channel" {
		Reference = "M_Channel"
		RefineWindow = Rectangle [(0.15 0.0415) (0.238 0.0575)]
	}
	Refinement "M_PL_Bot_Ox" {
		Reference = "M_Ox"
		RefineWindow = Rectangle [(0.169 0.04) (0.219 0.0415)]
	}
	Refinement "M_PL_Top_Ox" {
		Reference = "M_Ox"
		RefineWindow = Rectangle [(0.169 0.0575) (0.219 0.059)]
	}
	Refinement "M_PL_Source_Spacer" {
		Reference = "M_Source_Spacer"
		RefineWindow = Rectangle [(0.15 0) (0.169 0.099)]
	}
