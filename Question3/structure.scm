...
; filename
(define filename (list "dgate_tspace2" "dgate_tspace6" "dgate_tspace10" "dgate_tspace14" "dgate_tspace18" 
	"dgate_tspace22" "dgate_tspace26" "dgate_tspace30"))

; device dimensions
(define Tox 0.0015)
(define Lg 0.050)
(define Lsd 0.150)
(define Tspacer (list 0.002 0.006 0.010 0.014 0.018 0.022 0.026 0.030))
(define Hraise 0.040)
(define Lext 0.010)
(define Tsi 0.016)
...
(for-each 
	(lambda (Tspacer filename)
		...
		(sdedr:define-gaussian-profile "G_SDext_Dope" "ArsenicActiveConcentration" "PeakPos" 0 "PeakVal" SDext_Dope "Length" 0.002 "Gauss" "Factor" 0)
